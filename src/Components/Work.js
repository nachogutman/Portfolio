...
function Work({ position, company, location, type, duration }) {
  return (
    <article className="pt-8 border-b-2 border-light-content border-opacity-20">
      <div className="flex justify-between items-center">
        <h1 className=" md:text-lg lg:text-xl text-light-heading ">{position}</h1>
      </div>
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className=" text-xs md:text-sm font-light pl-1 text-light-heading ">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className=" text-xs md:text-sm font-light pl-1 text-light-heading ">{location}</p>
          </div>
        </div>
        <p className=" text-xs md:text-sm font-light pl-1 min-w-fit text-light-heading ">{duration}</p>
      </div>
    </article>
  );
}
